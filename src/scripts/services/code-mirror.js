(function () {
  ...
  angular.module('codeMirror', ['testCasesEditor'])//, 'codeFolding'])
    .factory('codeMirror', function (
      $rootScope, codeMirrorHighLight,
      isArrayStarter, getSpaceCount, getTabCount, extractKeyValue, generateSpaces, generateTabs //,getFoldRange,
    ) {
      var editor  = null;
...
*/
      ...
      service.createEditor = function (el, extraOptions) {
        var shouldEnableFoldGutter = 'true'//JSON.parse(config.get('folding', 'true'));
